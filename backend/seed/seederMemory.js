...
const seedInMemory = async () => {
  try {
    console.log('InMemory Seed: Cleaning old collections...');
    ...
    console.log('InMemory Seed: Seeding default Admin...');
    ...
    console.log('InMemory Seed: Seeding Departments...');
    const depsData = [
    ...
    console.log('InMemory Seed: Seeding Classrooms and Labs...');
    ...
    console.log('InMemory Seed: Seeding Faculty...');
    ...
    console.log('InMemory Seed: Seeding Subjects...');
    ...
    console.log('InMemory Seed: Seeding Students...');
    ...
    console.log('InMemory Seed: Invoking schedule generator...');
    const schedulingResult = await generateTimetable();
    await Timetable.insertMany(schedulingResult.scheduled);

    console.log('InMemory Seed: Seeding Notifications...');
    ...
    console.log('InMemory Seed: Completed successfully.');
  } catch (err) {
